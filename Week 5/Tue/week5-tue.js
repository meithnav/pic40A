...
var custCar2 = {
  ...
  accelerate: function (boost) {
    ...
    console.log("New Spped : ", custCar2.maxSpeed, ", Car: ", custCar2.brand);
  },
};
...
//   accelerate: function (boost) {
//     this.maxSpeed += boost;
//     console.log("New Spped : ", this.maxSpeed);
//   },
// };
...
class Admin extends User {
  // it copies all the properties of User
...
function Admin2(...args) {
  // ...args is called destructuring. We will take the exact argument we get during the function call and store it in the array.
...
console.log(
  "\n Class Prototype === obj's __proto__",
  Admin2.prototype === adrien2.__proto__
);
