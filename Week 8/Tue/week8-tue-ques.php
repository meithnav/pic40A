...
// TEST CASE:
$para = "PHP is a popular general-purpose scripting language that is especially suited to web development.";

echo "The longest word is: " . findLongestWord($para);
